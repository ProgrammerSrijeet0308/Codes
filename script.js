...
var heading= document.querySelectorAll(".parallax h1");
var content= document.querySelectorAll(".parallax p");
...
function OnScroll(event)
{
	...
	{
		activate(3)
		parallax[2].style.backgroundPositionY=(window.pageYOffset-3*window.innerHeight)*0.9+"px";
	}
}
